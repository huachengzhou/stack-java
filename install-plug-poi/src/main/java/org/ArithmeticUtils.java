...
public class ArithmeticUtils implements Serializable {
    ...
    public static BigDecimal roundBigDecimal(BigDecimal v, int scale) {
        ...
        BigDecimal bigDecimal = v.setScale(scale, BigDecimal.ROUND_HALF_UP);
        String decimalString = getBigDecimalString(bigDecimal);
        return createBigDecimal(decimalString) ;
    }
    ...
    public static BigDecimal parseFormatBigDecimalNew(String value)  {
        try {
            return createBigDecimal(parseFormatNumber(value).toString());
