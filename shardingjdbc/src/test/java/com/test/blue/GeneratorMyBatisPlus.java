...
public class GeneratorMyBatisPlus {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://localhost:3306/shard-jdbc-master?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.blue";
     ...
     * 项目根路径
     */
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir") + File.separator + "shardingjdbc";
...
//                        .addTableFills(new Column("update_time", FieldFill.INSERT_UPDATE))
    ...
    private static List<String> getTables() {
        return Arrays.asList("tb_ms_school_info");
    }
